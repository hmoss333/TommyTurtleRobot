...
public class Abilities1 : MonoBehaviour
{
    ...
    public void addJump() { movement.Add("Jump"); showMoves.text = showMoves.text + "Jump..."; lineSkip(4); playSound(6); jumpCount += 1; }
    ...
    {
        jumpCount = 0;
        help.text = "Tommy's friend can fly high. Can you <b><color=yellow>Jump</color></b> just as high?";
        playSound(2);
        movementLengthCollection = 0;
        movement.Clear();
